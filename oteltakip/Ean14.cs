...
namespace oteltakip
{
    class Ean14
    {
        ...
        public Ean14( string mfgNumber, string productId )
		{
			this.CountryCode = "00";
		...
		public Ean14( string countryCode, string mfgNumber, string productId )
		{
		...
		public Ean14( string countryCode, string mfgNumber, string productId, string checkDigit )
		{
			this.CountryCode = countryCode;
			this.ManufacturerCode = mfgNumber;
			this.ProductCode = productId;
